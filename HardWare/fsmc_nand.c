...
void FlashWriteAddr4Byte(uint32 Addr)
{
 ...
 /* 
   FlashWriteAddr( 0xff&Addr);
   FlashWriteAddr( 0x07&Addr>>8);
   FlashWriteAddr( 0xff&Addr>>11);
   FlashWriteAddr( 0xff&Addr>>19);
   if(FLASH_MAX_ADDR==0xFFFFFFF) FlashWriteAddr( 0x1&Addr>>27);*/
}
/////////////////////////End of function/////////////////////////////
/********************************************************************
