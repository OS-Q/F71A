...
#include "memory.h"
#include "mass_mal.h"
#include "usb_massdesc.h"
#include "usb_massprop.h"
#include "usb_lib.h"
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
/* Private macro -------------------------------------------------------------*/
...
{
  return Standard_GetDescriptorData(Length, &Mass_Device_Descriptor );
}
...
{
  return Standard_GetDescriptorData(Length, &Mass_Config_Descriptor );
}
...
u8 *MASS_GetStringDescriptor(u16 Length)
{
  ...
  {
    return Standard_GetDescriptorData(Length, &Mass_String_Descriptor[wValue0]);
  }
}
