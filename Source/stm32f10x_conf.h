...
/* Uncomment the line below to compile the library in DEBUG mode, this will expanse
   ...
   section below) */
/* #define DEBUG    1*/
#define VECT_TAB_RAM   0 		//1:中断向量表偏移至RAM区,0:中断向量表偏移至FLASH区
#define USE_BITBAND_OPERATE  1  //使能位带操作
#define EN_USART1_RX    0       //1 使能接受，0 禁用接受
#define ADJ_SAVE_ENABLE 1       //使能触屏校正保存 
#define FLASH_WRITE_EN  1   	//允许flash写操作
